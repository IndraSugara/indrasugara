...
I am a passionate software engineer with expertise spanning **Full Stack Development**, **Artificial Intelligence & Machine Learning**, and **Network Engineering**. I enjoy building intelligent systems that are not only functional but also scalable and maintainable.
...
| Domain | Focus |
|---|---|
| 🤖 **AI / ML** | Model training, data preprocessing, NLP, computer vision |
| 🌐 **Full Stack** | REST APIs, web applications, database design |
| 🔌 **Network** | Network configuration, monitoring, security fundamentals |
...
I am always open to discussing new ideas, collaboration opportunities, or simply talking about technology.
